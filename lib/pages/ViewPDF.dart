      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Column(
                children: widget.title == 'Tata Tertib'? tatib.map((strone){
                return Row(
                children:[
            ...
            ).toList(): widget.title == 'Petunjuk'? petunjuk.map((strone){
                  return Row(
                      children:[
                        Text("\u2022", style: TextStyle(fontSize: (30)),), //bullet text
                        SizedBox(width: 10,), //space between bullet and text
